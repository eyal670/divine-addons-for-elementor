...
class Modules {
    ...
    public function scripts_registered() {
        ...
        wp_enqueue_script('iframe-list-js', plugin_dir_url( __FILE__ ) . 'assets/js/iframe-list.js', array(), filemtime( plugin_dir_path( __FILE__ ) .  'assets/js/iframe-list.js'), 'true' );
    }
}
